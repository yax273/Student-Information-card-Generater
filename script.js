let btn = document.getElementById("genretoerBtn");
...
btn.addEventListener("click", function () {
    ...
    if (photoInput.files && photoInput.files[0]) {
        ...
        render.readAsDataURL(photoInput.files[0]);

    } else {
        cardImage.src = "https://plus.unsplash.com/premium_photo-1671656349322-41de944d259b?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
    }
